        ...
        <div className="w-full px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 w-full">
                {props.input.cards.map((cardWithState) => {
                    const notesHtml = getFlashCardBackNotes(cardWithState.card);
                                ...
                                <CardContent className="px-4 py-5 sm:p-6 flex-1 flex flex-col justify-center items-center">
                                    ...
                                    {cardWithState.flipped ? (
                                        <div className="mb-4 w-full space-y-3">
                                            ...
                                            {notesOpenCardIds.includes(cardWithState.card.id) && notesHtml ? (
                                                <div
                                                    className="w-full rounded-md border bg-muted/30 p-3 text-sm text-muted-foreground"
                                            ...
                                            {getFlashCardBackText(cardWithState.card) ? (
                                                <div className="flex justify-center">
                                                    <Button
                                                        ...
                                                        size="sm"
                                                        variant="outline"
                                                        onClick={() => playCardAudio(cardWithState.card.id, getFlashCardBackText(cardWithState.card), "de")}
